...
<nav>
        <div class="navContent">
			...
			<ul>
			           <h3 style="margin-left:2%;"> View available books</h3>
			</ul>
...
<input type="text" placeholder="SEARCH BOOK ID....." name="bookID" style="border:3px solid grey; border-radius: 15px; width:50% ">

<input type="submit" name="searchBook" value="SEARCH DATA">
...
if ($row = mysqli_fetch_array($results))
{
        ...
        echo "<table>";
		echo "<h3>Results found for Book ID '$bookID'</h3>";
            echo "<tr>";
			    echo "<th>Book Id</th>";
	...
	echo "<h3>No records match '$bookID.<h3/>";

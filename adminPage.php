...
<!--  Clickcease.com tracking-->
    ...
    <div class="container">
        <div class="col-xs-12 col-md-6 col-sm-12 top-user info-top-left background-color:transparent" >
            <div class="user-name">
                <p>
...
<nav>
        <div class="navContent" style="background-color:transparent">
            <ul>
                <li>
                    <div class="sideMenu">
                        ...
                        <div id="menu" class="sidebar">
                            <h3>BOOKTHRIFT</h3>
						    <a href="adminPageStudentView.php">VIEW STUDENTS</a>
			...
			<ul>
			           <h3 style="margin-left:2%;"> Search For A Student</h3>
...
<input type="text" placeholder="SEARCH STUDENT ID....." name="studentID" style="border:3px solid grey; border-radius: 15px; width:50% ">

<input type="submit" name="searchUser" value="SEARCH DATA">
...
if ($row = mysqli_fetch_array($result))
{
		...
		echo "<h3>Results found for '$studentID'</h3>";
            echo "<tr>";
	...
	echo "<h3>No records match '$studentID.<br> Register the student<h3/>";
